...
class SelectedBillerScreen extends StatefulWidget {
  final BillerGroupsResponse selectedBiller;
  const SelectedBillerScreen({super.key,required this.selectedBiller});

  @override
  State<SelectedBillerScreen> createState() => _SelectedBillerScreenState();
}

class _SelectedBillerScreenState extends State<SelectedBillerScreen> {
      ...
      child: BlocBuilder<BillBloc, BillState>(
          builder: (context, state) {
            ...
            if (state is BillGetBillerPackageSuccessState) {
              WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
                billerPackageList = state.response;
                Future.delayed(Duration.zero, () {
          ...
          return AppUtils().loadingWidget2(
            ...
            child: Scaffold(
                  ...
                  child: Center (
                    ...
                    blueBtn(
                        ...
                        tap: () {
                          ...
                          bloc.add(BillGetCustomerLookUpEvents(request: BillsCustomerLookUpRequest(
                              customerId: customerIDControl.text,
                              billerSlug: selectedCategory?.slug ?? "",
              ...
              body: Column(
                children: [
                  appBarBackAndTxt(title: "${widget.selectedBiller.name} payment",
                      ...
                      GestureDetector(
                        onTap: (){
                          if(billerGroupDetailsList.isNotEmpty){
                            ...
                            bloc.add(BillGetBillerGroupsDetailsEvents(billerId: widget.selectedBiller.id));
                          }
    ...
    var result =  await showModalBottomSheet(
        ...
        builder: (context) => Padding(
          ...
          child:  SelectBillGategoryBottomSheet(
            titleText: "Select ${widget.selectedBiller.name} category",
            items: categoryList,
            height: 750.h,),
        )
    );
