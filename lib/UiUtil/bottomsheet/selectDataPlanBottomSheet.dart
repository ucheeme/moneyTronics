...
class SelectDataPlanBottomSheet extends StatefulWidget {
  final String titleText;
  final List<PresetAmountList> items;
  final double height;
  const SelectDataPlanBottomSheet({
    super.key, required this.titleText, required this.items, required this.height});

  @override
  State<SelectDataPlanBottomSheet> createState() => _SelectDataPlanBottomSheetState();
}

class _SelectDataPlanBottomSheetState extends State<SelectDataPlanBottomSheet> {
  @override
        ...
        child: Row(
          children: [
            SizedBox(width: 300.w,
                child: ctmTxtGroteskMid(title,AppColors.black1A,18.sp,maxLines: 1))
          ],),
      ),
    );
  }
